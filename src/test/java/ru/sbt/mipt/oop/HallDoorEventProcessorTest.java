...
public class HallDoorEventProcessorTest {
    ...
    private Light light0 = new Light("0", true);
    ...
    private EventHandler hallDoorEventProcessor = new HallDoorEventProcessor(smartHome);

    @Test
    public void handleHallDoorClosedEvent() {
        hallDoorEventProcessor.handle(new SensorEvent(DOOR_CLOSED, "2"));
    ...
    @Test
    public void handleHallDoorOpenedEvent() {
        hallDoorEventProcessor.handle(new SensorEvent(DOOR_OPEN, "2"));
    ...
    @Test
    public void handleNotHallDoorEvent() {
        hallDoorEventProcessor.handle(new SensorEvent(DOOR_CLOSED, "0"));
        hallDoorEventProcessor.handle(new SensorEvent(DOOR_OPEN, "1"));
        assertTrue(light0.isOn());
        assertTrue(light1.isOn());
        assertFalse(light2.isOn());
